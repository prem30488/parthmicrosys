...
import RefundPolicySectionOne from "@/components/refundPolicy/RefundPolicySectionOne";

import { Metadata } from "next";

export const metadata: Metadata = {
  title: "About Page | Parth Microsys",
  description: "About Parth Microsys - Refund Policy",
  // other metadata
};
...
const PrivacyPage = () => {
  return (
    <>
      <Breadcrumb
        pageName="About Parth Microsys - Refund Policy"
